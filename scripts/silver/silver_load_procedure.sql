...
-- Purpose   : Transform and load data from Bronze layer 
--             into Silver layer (cleaned and standardized)
-- Notes     : Includes data quality checks and transformations
-- ==========================================================
...
BEGIN
    ...
    BEGIN TRY
        ...
        PRINT '=================================================================';
        PRINT '>> Full Silver Load Duration: ' 
              + CAST(DATEDIFF(SECOND, @full_start_time, @full_end_time) AS NVARCHAR) + ' seconds';
